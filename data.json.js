export let data = {
	...
	"urgentmeasures": {
		...
		"text": {
			...
			"_da": "Giver du David Fauhoux, formand for ungdomsprogrammet, tilladelse til, om nødvendigt og efter telefonisk kontakt med dig, at træffe alle de påtrængende nødvendige foranstaltninger for dit barn (indlæggelse og/eller kirurgisk operation)?",
		...
		"generate": [
			...
			},
			{
				...
				"text": {
					...
					"_lt": "Įgalioju David Fauthoux, taip pat kitų vaikų tėvus ir prižiūrėtojus paskelbti mano vaiko nuotraukas viešose vietose (žaidimai, treniruotės, kelionės, maitinimas, veikla lauke) Facebook puslapyje.",
	...
	"accounts": {
		...
		"text": {
			...
			"_es": "Abajo las cuentas del viaje (vacío hasta que te lo llenemos). El número de cuenta es:<div class=\"banco\">IBAN <span class=\"copiable\">FR76 1027 8022 2200 0204 4250 174</span></div><div class=\"banco\">SWIFT/BIC <span class=\"copiable\">CMCIFR2A</span></div><div class=\"bank\">(Nombre: El equipo de viaje).</div>",
