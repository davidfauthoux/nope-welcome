export let data = {
	...
	"philosophy": {
		...
		"text": {
			...
			"_es": "El objetivo de 3T es muy simple y muy sólido: que los niños de todo el <span class=\"emph\">mundo</span> se conozcan, se hagan <span class=\"emph\">amigos</span>, compartan sus la cultura y sus diferencias, a través de un auténtico y destacado momento deportivo, requiriendo por tanto de ellos una gran implicación.",
		...
		"generate": [
			...
			},
			{
				"text": {
					...
					"_lv": "Es saprotu, ka visi dalībnieki un kompetentās iestādes uzskata braucienu par ģimenes un draugu organizētu braucienu, jauniešu programma NAV komercsabiedrība, un vecāki, kas nāk līdzi un piedalās apdrošināšanas izmaksās. Līdz ar to ceļojums ir regulāra uzturēšanās kopā ar ģimenēm un draugiem, un tam nav nepieciešama papildu administratīvā deklarācija.",
