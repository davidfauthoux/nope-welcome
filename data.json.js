export let data = {
	...
	"swim": {
		...
		"text": {
			...
			"_sv": "Vet ditt barn hur man simmar?",
	...
	"_signedparentalauthorization": {
		"title": {
			...
			"_da": "Signer og upload",
			"_ee": "Allkirjastage ja laadige üles"
		},
		"text": {
			...
			"_lt": "Pasirašykite ir įkelkite anksčiau atspausdintą tėvų įgaliojimą.",
			"_lv": "Lūdzu, parakstiet un augšupielādējiet iepriekš izdrukāto vecāku pilnvarojumu.",
			"_ru": "Пожалуйста, подпишите и загрузите родительское разрешение, которое вы распечатали ранее.",
		...
		"back": {
			"parentalauthorization": {
				...
				"it": "Stampa di nuovo",
				"_lt": "Spausdinkite dar kartą",
				"_lv": "Drukājiet vēlreiz",
				"_ru": "Распечатать снова",
				"_fi": "Tulosta uudelleen",
				"_sv": "Skriv ut igen",
				"_da": "Udskriv igen",
				"_ee": "Printige uuesti"
			}
