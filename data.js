	...
	language: {
		...
		account: {
			...
			recovery: {
				...
				text: {
					en: "We sent you a recovery email, please check your email box.",
					fr: "Nous vous avons envoyé un e-mail de récupération, veuillez vérifier votre boîte e-mail.",
					es: "Le enviamos un correo electrónico de recuperación, verifique su casilla de correo electrónico.",
					it: "Ti abbiamo inviato un'e-mail di recupero, controlla la tua casella di posta elettronica.",
				},
				type: "text",
			},
			failed: {
